...
namespace UnityEngine.AddressableAssets {
    ...
    public class AssetListHandle<T> : AssetListHandle, IAssetListHandle<AssetListHandle<T>, T> where T : notnull, UnityEngine.Object {
        ...
        // Constructor
        public AssetListHandle(params string[] keys) {
            Keys = keys;
        }
